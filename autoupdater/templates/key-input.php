<tr id="<?php echo esc_attr( sanitize_title( $this->plugin_slug . '_licence_key_row' ) ); ?>" class="active plugin-update-tr wpem-updater-licence-key-tr">
	<td class="plugin-update" colspan="3">
		<div class="wpem-updater-licence-key">
	...
	<script>
		jQuery(function(){
			jQuery('tr#<?php echo esc_attr( $this->plugin_slug ); ?>_licence_key_row').prev().addClass('wpem-updater-licenced');
		});
	</script>
</tr>